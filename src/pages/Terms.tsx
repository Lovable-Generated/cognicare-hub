          ...
          <CardContent className="prose prose-invert max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using RapidSmiles services, you accept and agree to be bound by the terms and provision of this agreement. 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                RapidSmiles provides a platform to connect patients with dental professionals. Our services include:
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                RapidSmiles is a platform that facilitates connections between patients and healthcare providers. 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                associated with services booked through RapidSmiles. Refund policies vary by provider.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                RapidSmiles shall not be liable for any indirect, incidental, special, consequential, or punitive 
            ...
            <section>
              ...
              <div className="text-muted-foreground ml-4 mt-2">
                <p>Email: legal@rapidsmiles.com</p>
            ...
            <div className="mt-8 pt-6 border-t border-border">
              <p className="text-sm text-muted-foreground text-center">
                © {new Date().getFullYear()} RapidSmiles. All rights reserved.
              </p>
            </div>
          </CardContent>
        </Card>
